...
from network import image_decoder, image_encoder, image_output, image_optimizer, gan_optimizer
...
class AutoGanGenerator(GANetwork):
    ...
    def setup_network(self):
        ...
        auto_code = image_encoder([self.image_input_scaled], 'autoencoder', self.image_size, self._dis_conv, self._dis_width, self._class_depth, self._dropout, self.input_size, False)[0]
        ...
        with tf.variable_scope('train'):
            ...
            self.generator_solver, self.discriminator_solver = \
                gan_optimizer(None, gen_var, dis_var, gen_logit, image_logit, self._y_offset, 1-self._y_offset, True,
